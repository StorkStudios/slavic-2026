    ...
    public class Terminal : Singleton<Terminal>
    {
        ...
        public TerminalState State
        {
            ...
            private set
            {
                ...
                {
                    state = value;
                    TerminalStateChangedEvent?.Invoke(value);
                }
            }
        }
        private TerminalState state;

        public event System.Action<TerminalState> TerminalStateChangedEvent;
        ...
        public static void AddLogEntry(string format, params object[] message)
        {
            AddLogEntry(TerminalLogType.ShellMessage, format, message);
        }

        public static void AddLogEntry(TerminalLogType type, string format, params object[] message)
        {
        ...
        protected override void Awake()
        {
            ...
            if (IssuedError)
            {
                AddLogEntry(TerminalLogType.Error, "Error: {0}", Shell.IssuedErrorMessage);
            }
            ...
            InputAdapter.toggleConsole.performed += (_) => ToggleState(); 
        }
        ...
        void DrawGUIButtons()
        {
            ...
            if (GUILayout.Button("Full", window_style))
            {
                ToggleState();
            }
        ...
        void EnterCommand()
        {
            AddLogEntry(TerminalLogType.Input, "{0}", command_text);
